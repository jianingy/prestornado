...
from prestornado import common
from prestornado.common import DBAPITypeObject
# Make all exceptions visible in this module per DB-API
from prestornado.exc import *
...
class Cursor(common.DBAPICursor):
    ...
    def __init__(self, host, port='8080', username=None, catalog='hive', schema='default',
                 poll_interval=1, source='prestornado'):
        """
    ...
    def execute(self, operation, parameters=None):
        ...
        self._process_response((yield client.fetch(request, raise_error=False)))
    ...
    def _fetch_more(self):
        ...
        request = HTTPRequest(self._nextUri)
        client = AsyncHTTPClient(max_clients=512)
        self._process_response((yield client.fetch(request)))
    ...
    def _process_response(self, response):
        ...
        if response.code != 200:
            ...
            raise OperationalError(fmt.format(response.code, response.body))
